                ...
                <div class="col-lg-6 col-md-6">
                    <div class="login_part_text text-center">
                        <div class="login_part_text_iner">
                            ...
                            <a href="<?php echo base_url();?>account/login" class="btn_3">Login</a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 col-md-6">
                    <div class="login_part_form">
                        <div class="login_part_form_iner">
                            ...
                            <?php endif; ?>
                            <form class="row contact_form" action="<?php echo base_url('Account/check_register');?>" autocomplete="off" method="post" novalidate="novalidate">
