						...
						<div class="nav-tabs-horizontal" data-plugin="tabs">
							<ul class="nav nav-tabs" role="tablist">
                                <li class="nav-item" role="presentation">
                                    <a class="nav-link active" onclick="getdatawarna()" data-toggle="tab" href="#exampleTabsTwo" aria-controls="exampleTabsTwo" role="tab">List Warna</a>
                                </li>
							</ul>
							<div class="tab-content pt-20">
								<div class="tab-pane active" id="exampleTabsTwo" role="tabpanel" style="margin-left: 2%;margin-right: 2%;">
                                <button type="button" onclick="window.location.href='<?php echo base_url();?>WarnaAdmin/TambahWarna'" class="btn btn-block btn-info waves-effect waves-classic col-md-2" style="margin-bottom:3%">Tambah Warna</button>
                                ...
                                <?php endif; ?>
									...
									<div class="row" style="margin-bottom: 3%">
										...
										<div class="col-md-2">
											...
											<button type="button" onclick="getdatawarna()" class="btn btn-block btn-success waves-effect waves-classic">Cari</button>
										</div>
										<!-- <div class="col-md-3">
											<h4 class="example-title" style="color: white;">Begin</h4>
...
<script type="text/javascript">
	...
	{
		location.href = '<?php echo base_url();?>WarnaAdmin/detail/'+id;
	}
</script>