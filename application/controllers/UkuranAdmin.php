...
class UkuranAdmin extends CI_Controller {
	...
	public function index()
	{
		...
		$this->load->view('ukuran/ukuranadmin');
		$this->load->view('footerAdmin');
	}
	public function searchdataukuran()
	{
		$begin = $this->input->post('begin');

		$data = $this->ProdukModel->getListUkuran($begin);
	...
	{
		$data['data'] = $this->ProdukModel->getdetailUkuran($id);
		$this->load->view('headerAdmin');
		$this->load->view('ukuran/detailukuranadmin',$data);
		$this->load->view('footerAdmin');
	}
	public function TambahUkuran()
	{
		$this->load->view('headerAdmin');
		$this->load->view('ukuran/addukuran');
		$this->load->view('footerAdmin');
	}
	public function editukuran()
	{
		$id_size = $this->input->post('id_ukuran');
		$size_name = $this->input->post('ukuran_name');
		$this->ProdukModel->updateUkuran($id_size,$size_name);
		
		
		$this->session->set_flashdata('alert', 'Berhasil Merubah Size');
		redirect(base_url('UkuranAdmin/index'));
	}
	public function addukuran()
	{
		// $id_kategori = $this->input->post('id_kategori');
		$size_name = $this->input->post('ukuran_name');
		$this->ProdukModel->insertukuran($size_name);
		
		
		$this->session->set_flashdata('alert', 'Berhasil Menambahkan Size');
		redirect(base_url('UkuranAdmin/index'));
	}
