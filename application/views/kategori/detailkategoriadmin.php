	...
	<div class="page-content">
		<div class="panel">
			...
			<div class="panel-body container-fluid">
				<form method="POST" action="<?php echo base_url('KategoriAdmin/editkategori');?>">
					...
					<div class="row row-lg" style="margin-top: 3%;">
						<div class="col-md-12">
							...
							<input type="text" value="<?php echo $data['category_name']?>" name="kategori_name" class="form-control col-md-6" required="required" >
						</div>
					</div>
